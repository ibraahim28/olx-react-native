export const categories = [
    { id: "1", title: "Mobiles", image: require("./assets/mobiles.png"), bgColor: "#FFEEEE" },
    { id: "2", title: "Vehicles", image: require("./assets/vehicles.png"), bgColor: "#FFF2C5" },
    { id: "3", title: "Property For Sale", image: require("./assets/property-sale.png"), bgColor: "#FFD9C0" },
    { id: "4", title: "Property For Rent", image: require("./assets/property-rent.png"), bgColor: "#E8F8FF" },
    { id: "5", title: "Electronics & Home Appliances", image: require("./assets/electronics.png"), bgColor: "#FDF5C9" },
    { id: "6", title: "Bikes", image: require("./assets/bikes.png"), bgColor: "#E0FFFF" },
    { id: "7", title: "Business, Industrial & Agriculture", image: require("./assets/business.png"), bgColor: "#E8F8FF" },
    { id: "8", title: "Services", image: require("./assets/services.png"), bgColor: "#FFE4C4" },
    { id: "9", title: "Jobs", image: require("./assets/jobs.png"), bgColor: "#D3D3D3" },
    { id: "10", title: "Animals", image: require("./assets/animals.png"), bgColor: "#FFDDC1" },
    { id: "11", title: "Furniture & Home Decor", image: require("./assets/furniture.png"), bgColor: "#ADD8E6" },
    { id: "12", title: "Fashion & Beauty", image: require("./assets/fashion.png"), bgColor: "#E6E6FA" },
    { id: "13", title: "Books, Sports & Hobbies", image: require("./assets/books.png"), bgColor: "#FFA07A" },
    { id: "14", title: "Kids", image: require("./assets/kids.png"), bgColor: "#FFDAB9" },
  ];
